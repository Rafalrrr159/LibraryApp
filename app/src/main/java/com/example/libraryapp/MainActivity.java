...
public class MainActivity extends AppCompatActivity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == NEW_BOOK_ACTIVITY_REQUEST_CODE && resultCode == RESULT_OK) {
            ...
            bookEdit.setTitle(data.getStringExtra(EditBookActivity.EXTRA_EDIT_BOOK_TITLE));
            bookEdit.setAuthor(data.getStringExtra(EditBookActivity.EXTRA_EDIT_BOOK_AUTHOR));
            bookViewModel.update(bookEdit);
    ...
    private class BookHolder extends RecyclerView.ViewHolder{
        ...
        public BookHolder(LayoutInflater inflater, ViewGroup parent) {
            ...
            itemView.findViewById(R.id.book_element).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick (View view) {
                    bookEdit = book;
                    Intent intent = new Intent(MainActivity.this, EditBookActivity.class);
            ...
            itemView.findViewById(R.id.book_element).setOnLongClickListener(new View.OnLongClickListener() {
                @Override
